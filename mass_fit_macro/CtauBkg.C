...
//  ws->factory("lambdaDSS_Bkg[0.5, 1e-6, 1.]");}
  ...
  RooAbsPdf *pdfTot_Bkg = new RooAddPdf("pdfTot_Bkg", "pdfTot_Bkg", RooArgList(*ws->pdf("pdfCTAU_Bkg")), RooArgList(*ws->var("N_Bkg")));
  ...
  ws->pdf("pdfTot_Bkg")->setNormRange("ctauWindow");
  ...
  ws->pdf("pdfTot_Bkg")->plotOn(myPlot2_E, Name("ctauBkg_Tot"),  Normalization(normBkg, RooAbsReal::NumEvent), NumCPU(nCPU),
  ...
  ws->data("dataToFit")->plotOn(myPlot2_E, Name("data_ctauBkg"), DataError(RooAbsData::SumW2), XErrorSize(0), MarkerColor(kBlack), LineColor(kBlack), MarkerSize(0.7));
  if (ws->pdf("pdfCTAU_BkgPR")) {ws->pdf("pdfTot_Bkg")->plotOn(myPlot2_E,Name("BKGPR"),Components(RooArgSet(*ws->pdf("pdfCTAU_BkgPR"))), ProjWData(RooArgSet(*ws->var("ctau3DErr")), *ws->data("dataw_Bkg"), kTRUE), Normalization(normBkg, RooAbsReal::NumEvent), LineColor(kRed+2), Precision(1e-4), NumCPU(nCPU));}
  if (ws->pdf("pdfCTAU_BkgNoPR")) {ws->pdf("pdfTot_Bkg")->plotOn(myPlot2_E,Name("BKGNoPR"),Components(RooArgSet(*ws->pdf("pdfCTAU_BkgNoPR"))), ProjWData(RooArgSet(*ws->var("ctau3DErr")), *ws->data("dataw_Bkg"), kTRUE), Normalization(normBkg, RooAbsReal::NumEvent), LineColor(kOrange+10), Precision(1e-4), NumCPU(nCPU));}
  ws->pdf("pdfTot_Bkg")->plotOn(myPlot2_E,Name("PDF"),  Normalization(normBkg, RooAbsReal::NumEvent), NumCPU(nCPU), ProjWData(RooArgSet(*ws->var("ctau3DErr")), *ws->data("dataw_Bkg"), kTRUE), LineColor(kBlack), Precision(1e-4));
