...
void doSimultaneousV2MassFit_pt65_50_y0_24_cent20_120_test(int cLow = 20, int cHigh = 120,
    ...
    float SiMuPtCut = 0, float massLow = 3.4, float massHigh =4.0, bool dimusign=true, int ibkg_vn_sel = fpol1, bool fixSigPar=true)
{
  ...
  Double_t cheb0_ = 0.0411151;
  Double_t cheb1_ = 0.02123635;
  Double_t cheb2_ = 0.02842316;
  Double_t c_  = 0.052;
  Double_t c1_ = 0.11240210;
  Double_t c2_ = 0.30320173;
  Double_t c3_ = 0.00480612;
  ...
  h_v2_SplusB->GetYaxis()->SetRangeUser(0.08,0.22);
