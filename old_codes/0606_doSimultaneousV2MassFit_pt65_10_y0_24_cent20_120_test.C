    ...
    float SiMuPtCut = 0, float massLow = 3.4, float massHigh =4.0, bool dimusign=true, int ibkg_vn_sel = fpol1, bool fixSigPar=true)
{
  ...
  Double_t cheb0_ = 0.00710;
  Double_t cheb1_ = 0.00818;
  Double_t cheb2_ = 0.00321;
  Double_t c_  = 0.15103;
  Double_t c1_ = 0.12102;
  Double_t c2_ = 0.22811;
  ...
  h_v2_SplusB->GetYaxis()->SetRangeUser(0.06,0.22);
