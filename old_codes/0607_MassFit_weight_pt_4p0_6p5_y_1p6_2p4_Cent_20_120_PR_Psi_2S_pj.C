...
void MassFit_weight_pt_4p0_6p5_y_1p6_2p4_Cent_20_120_PR_Psi_2S_pj(
		float ptLow=4.0, float ptHigh=6.5,
		float yLow=1.6, float yHigh=2.4,
		int cLow=20, int cHigh=120,
		double sl1_mean = 0.212, double sl2_mean = 0.39, double sl3_mean = 0.39,
//opt1		double sl1_mean = 0.212, double sl2_mean = 0.39, double sl3_mean = 0.39,
//opt2		double sl1_mean = 0.22, double sl2_mean = 0.33, double sl3_mean = 0.39,
//###		double sl1_mean = 0.22, double sl2_mean = 0.33, double sl3_mean = 0.39,
		double N_Jpsi_high =12000, double N_Bkg_high = 3000000,
//opt1		double N_Jpsi_high =5000=50000-45000-35000-25000-12000=, double N_Bkg_high = 1000000=3000000,
//opt2		double N_Jpsi_high =21000, double N_Bkg_high = 2600000,
//###		double N_Jpsi_high =5000-21000 double N_Bkg_high = 1000000-2600000,
