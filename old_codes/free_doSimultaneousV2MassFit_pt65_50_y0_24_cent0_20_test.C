...
// here1
void free_doSimultaneousV2MassFit_pt65_50_y0_24_cent0_20_test(
		...
		float SiMuPtCut = 0, float massLow = 3.4, float massHigh =4.0, bool dimusign=true, int ibkg_vn_sel = fpol2)
{
	...
	TFile *wf = new TFile(Form("../roots/sim_fit_result/SimFitResult_%s.root", kineLabel.Data()),"recreate");
	...
	Double_t c_ = 0.0014;
	Double_t c1_ = 0.000884;
	Double_t c2_ = -0.0052097;
	Double_t c3_ = 0.01;
	// Double_t c_ = 0.0014;
	// Double_t c1_ = 0.000884;
	// Double_t c2_ = -0.0052097;
	...
	Double_t parLimitLow[nParmV]  = {      0,     0, mean_ -0.02,  0.01,   0.1,   0.1, 0 ,0.,     0,    0, -30, -30, -30};
	Double_t parLimitHigh[nParmV] = {N1_*1.2, Nbkg_*1.2, mean_ +0.02,  0.08,   9.8,   9.9, 1, 1,    25,  0.5,  30,  30,  30};
	...
	g_mass->GetYaxis()->SetRangeUser(800, 1300);
