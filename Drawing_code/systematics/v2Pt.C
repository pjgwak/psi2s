void v2Pt(){
    ...
    double ybin1[] = {0.192, 0.24, 0.139}; // v2
    double yerr[] = {0.063, 0.123, 0.072}; // Nominal
    double yerr2[] = {0.063, 0.123, 0.072}; // v2
    ...
    leg1->AddEntry(v2pt,"#splitline{Nominal}{(1st order polynomial)}");
    leg1->AddEntry(v2ptPrp,"#splitline{v2 fit function}{(2nd order polynomial)}");
    leg1->Draw("same");
