void BkgCent(){
    ...
    double ybin2[] = {0.132, 0.189}; // Bkg
    double xerr[] = {0.0, 0.0};
    double yerr1[] = {0.067, 0.111}; // Nominal staticstical
    double yerr2[] = {0.067, 0.111}; // Bkg staticstical
    ...
    leg1->AddEntry(v2cent,"#splitline{Nominal}{(3rd order Chebyshev)}");
    leg1->AddEntry(v2centPrp,"#splitline{Background}{(2nd order Chebyshev)}");
    leg1->Draw("same");

    c1->SaveAs("Bkg_cent.png");
}
