void EffCent(){
    ...
    double ybin2[] = {0.1, 0.177}; // Eff
    double xerr[] = {0.0, 0.0};
    double yerr1[] = {0.067, 0.111}; // Nominal staticstical
    double yerr2[] = {0.067, 0.111}; // Eff staticstical
    ...
    TLegend *leg1 = new TLegend(0.59,0.70,0.91,0.81);
    leg1->SetBorderSize(0);
    leg1->SetFillColor(0);
    leg1->SetFillStyle(0);
    leg1->SetTextSize(0.03);
    leg1->AddEntry(v2cent,"Nominal");
    leg1->AddEntry(v2centPrp,"#splitline{Efficiency}{(w/o p_{T} weight)}");
    leg1->Draw("same");

    c1->SaveAs("Eff_cent.png");
}
