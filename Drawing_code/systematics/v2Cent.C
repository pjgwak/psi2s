void v2Cent(){
    ...
    double ybin2[] = {0.111, 0.21}; // v2
    double xerr[] = {0.0, 0.0};
    double yerr1[] = {0.067, 0.111}; // Nominal staticstical
    double yerr2[] = {0.067, 0.111}; // v2 staticstical
    ...
    leg1->AddEntry(v2cent,"#splitline{Nominal}{(1st order polynomial)}");
    leg1->AddEntry(v2centPrp,"#splitline{v2 fit function}{(2nd order polynomial)}");
    leg1->Draw("same");

    c1->SaveAs("v2_cent.png");
}
