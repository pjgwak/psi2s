void SigPt(){
    ...
    double ybin1[] = {0.134, 0.23, 0.139}; // Sig
    double yerr[] = {0.063, 0.123, 0.072}; // Nominal
    double yerr2[] = {0.063, 0.123, 0.072}; // Sig
    ...
    leg1->AddEntry(v2pt,"Nominal (2 crystal balls)");
    leg1->AddEntry(v2ptPrp,"Signal (crystal ball + gaussian)");
    leg1->Draw("same");

    c1->SaveAs("Sig_pT.png");
}
