void SigCent(){
    ...
    double ybin2[] = {0.102, 0.192}; // Sig
    double xerr[] = {0.0, 0.0};
    double yerr1[] = {0.067, 0.111}; // Nominal staticstical
    double yerr2[] = {0.067, 0.111}; // Sig staticstical
    ...
    TLegend *leg1 = new TLegend(0.57,0.70,0.91,0.81);
    leg1->SetBorderSize(0);
    leg1->SetFillColor(0);
    leg1->SetFillStyle(0);
    leg1->SetTextSize(0.027);
    leg1->AddEntry(v2cent,"Nominal (2 crystal balls)");
    leg1->AddEntry(v2centPrp,"Signal (crystal ball + gaussian)");
    leg1->Draw("same");

    c1->SaveAs("Sig_cent.png");
}
