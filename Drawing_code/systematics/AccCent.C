void AccCent(){
	...
	double ybin2[] = {0.11, 0.195}; // Acc
	double xerr[] = {0.0, 0.0};
	double yerr1[] = {0.067, 0.111}; // Nominal staticstical
    double yerr2[] = {0.067, 0.111}; // Acc staticstical
	...
	leg1->AddEntry(v2centPrp,"#splitline{Acceptance}{(w/o p_{T} weight)}");
	leg1->Draw("same");

	c1->SaveAs("acc_cent.png");
}
