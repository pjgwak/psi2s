void BkgPt(){
    ...
    double ybin1[] = {0.175, 0.225, 0.139}; // Bkg
    double yerr[] = {0.063, 0.123, 0.072}; // Nominal
    double yerr2[] = {0.063, 0.123, 0.072}; // Bkg
    ...
    leg1->AddEntry(v2pt,"#splitline{Nominal}{(3rd order Chebyshev)}");
    leg1->AddEntry(v2ptPrp,"#splitline{Background}{(2nd order Chebyshev)}");
    leg1->Draw("same");

    c1->SaveAs("Bkg_pT.png");
}
