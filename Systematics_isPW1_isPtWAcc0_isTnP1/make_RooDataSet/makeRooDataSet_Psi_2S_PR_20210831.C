...
void makeRooDataSet_Psi_2S_PR_20210831(
		...
		int state=1) //state 0: inclusive, state 1: Prompt, state 2: NonPrompt
{
  ...
  TFile *rf;
  if(isMC){
    if(state==1) rf = new TFile("/Users/pjgwak/work/psi_2s_v2/primary_input/OniaFlowSkim_JpsiTrig_DBAllPD_isMC0_HFNom_201127.root","READ");
  ...
  else if(!isMC) rf = new TFile("/Users/pjgwak/work/psi_2s_v2/primary_input/OniaFlowSkim_JpsiTrig_DBAllPD_isMC0_HFNom_201127.root","read");
