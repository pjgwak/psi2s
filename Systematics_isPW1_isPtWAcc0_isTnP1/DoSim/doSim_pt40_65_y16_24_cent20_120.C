...
void doSim_pt40_65_y16_24_cent20_120(int cLow = 20, int cHigh = 120,
		...
		int ibkg_vn_sel = fpol1, bool fixSigPar=true)
{
  ...
  TFile* rf = new TFile(Form("../Psi2S_Prompt_%s_Eff1_Acc1_PtW1_PtWAcc0_TnP1.root",kineLabel.Data()),"read");
  ...
  TFile* f_mass = new TFile(Form("../MassFit/roots/mass/210901/MassFitResult_%s_PRw_Effw1_Accw1_PtW1_PtWAcc0_TnP1.root",kineLabel_.Data()),"read");
  ...
  Double_t sigma_ = ws->var("sigma_1_A")->getVal(); // 3
  Double_t alpha_ = ws->var("alpha_1_A")->getVal(); // 4
  Double_t n_ = ws->var("n_1_A")->getVal(); // 5
  Double_t ratio_ = ws->var("x_A")->getVal(); // 6
  Double_t frac_ = ws->var("f")->getVal(); // 7
  Double_t cheb0_ = ws->var("sl1")->getVal();
  Double_t cheb1_ = ws->var("sl2")->getVal();
  Double_t cheb2_ = ws->var("sl3")->getVal();
    Double_t c_  = 0.000000006401277;
    Double_t c1_ = 7.320754546545211;
    Double_t c2_ = 4.202055454564642;
  
  //}}}
  Double_t c3_ = 0.0210; //0.41210;
  Double_t c4_ = 0.2110;

  /*
   // ===== Nominal candidate1 - (c_  = 0.00000000640127"7") =====
   Double_t c_  = 0.000000006401277;
   Double_t c1_ = 7.320754546545211;
   Double_t c2_ = 4.202055454564642;
   
   // ===== Nominal candidate2 - (c_  = 0.00000000640127"6") =====
   Double_t c_  = 0.000000006401276;
   Double_t c1_ = 7.320754546545211;
   Double_t c2_ = 4.202055454564642;
   // ==============================
   ...
   Double_t c_  = 0.000000006401281;
   Double_t c1_ = 7.320754546545211;
   Double_t c2_ = 4.202055454564642;
   
   Double_t c_  = 0.000000006401294;
   Double_t c1_ = 7.320754546545223;
   Double_t c2_ = 4.202055454564652;
   
   Double_t c_  = 0.000000006401283;
   Double_t c1_ = 7.320754546545211;
   Double_t c2_ = 4.202055454564642;
   
   
   Double_t c_  = 0.000000006401292;
   Double_t c1_ = 7.32075454654522;
   Double_t c2_ = 4.202055454564652;
   
   
   Double_t c_  = 0.111278456401256;
   Double_t c1_ = 8.3207545465454501;
   Double_t c2_ = 10.2020554545646656;
   
   
     Double_t c_  = 0.216586;
     Double_t c1_ = 3.80529;
     Double_t c2_ = 4.62628;
     Double_t c3_ = 1.31210;
     */
  ...
  par0[14] = c3_;
  par0[15] = c4_;
                                                       //                3    4     5    6    7     8    9    10   c    c1   c2
  Double_t parLimitLow[nParmV]  = {    0,       0,     mean_ -0.02,      0,   0.,   0.,  0,   0,   -10, -10, -10,  0.0001,  -20, -20, -10, -10};
  Double_t parLimitHigh[nParmV] = {N1_*1.2, Nbkg_*1.2, mean_ +0.02,      0.1, 5.,   5.,  5.,  5.,   10,  10,  10, 0.25,  20,  20,  20,  20};
