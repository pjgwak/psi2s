...
void mc_pt10_50_y0_24_cent20_120(
		float ptLow=10, float ptHigh=50,
		float yLow=0, float yHigh=2.4,
		int cLow=20, int cHigh=120,
		double sl1_mean = 0.058, double sl2_mean = 0.036, double sl3_mean = 0.0204,
		double N_Jpsi_high = 7000, double N_Bkg_high = 100000,
		...
		)
{
    ...
    if (logY_flag == true) {
        //myPlot2_A->SetMinimum(2*10);
        myPlot2_A->SetMaximum(10000);
    }
    else {
        myPlot2_A->GetYaxis()->SetRangeUser(500,4000);
    }
    myPlot2_A->Draw();
