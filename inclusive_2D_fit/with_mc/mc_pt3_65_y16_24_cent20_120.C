...
void mc_pt3_65_y16_24_cent20_120(
		float ptLow=3., float ptHigh=6.5,
		float yLow=1.6, float yHigh=2.4,
		int cLow=20, int cHigh=120,
		double sl1_mean = 0.00358, double sl2_mean = -.006036, double sl3_mean = -.005204,
		double N_Jpsi_high = 40000, double N_Bkg_high = 5600000,
		...
		)
{
    ...
    double sigma_1_init = 0.0024;
    //0.023
    double x_init = 1.6703;
    double alpha_1_init = 2.6970;
    double n_1_init = 0.3942;
    double f_init = 0.181;
    //0.4
