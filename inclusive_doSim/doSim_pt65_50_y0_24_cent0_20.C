		...
		int ibkg_vn_sel = fpol1, bool fixSigPar=true)
{
    ...
    Double_t c_  = 0.00452212125;
    Double_t c1_ = 5.0104426080;
    Double_t c2_ = 5.0106450450;
	...
	Double_t parLimitLow[nParmV]  = {    0,       0, mean_ -0.02,   0.001,   0,   0,    0,     0,  -15, -15, -15,  -0.0, -30, -30, -30,-30};
	Double_t parLimitHigh[nParmV] = {N1_*1.3, Nbkg_*1.3, mean_ +0.02,    0.1,    5.1,   5,   5  ,   1,   15,  15,  14, 0.5,  30,  30,  30, 30};
