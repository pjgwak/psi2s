...
void mc_doSim_pt65_50_y0_24_cent20_120(int cLow = 20, int cHigh = 120,
		...
		float SiMuPtCut = 0, float massLow = 3.4, float massHigh =4.0, bool dimusign=true, int ibkg_vn_sel = fpol1, bool fixSigPar=true)
{
    ...
    Double_t parLimitLow[nParmV]  = {    0,       0, mean_-0.4,     0.0001,   0.,   0.,    0,     0,  -10, -10, -10,  0, -30, -30, -30,-30};
    Double_t parLimitHigh[nParmV] = {N1_*3, Nbkg_*4, mean_+0.4,      0.4,    5.,   5.,  5.,  1.,   10,  10,  10, 0.5,  30,  30,  30, 30};
