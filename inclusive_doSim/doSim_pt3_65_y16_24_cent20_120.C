...
void doSim_pt3_65_y16_24_cent20_120(int cLow = 20, int cHigh = 120,
		...
		int ibkg_vn_sel = fpol2, bool fixSigPar=true)
{
    ...
    Double_t c_  = 0.112125;
    Double_t c1_ = 0.606326080;
    Double_t c2_ = 0.020303150450;
    Double_t c3_ = 0.04023010;

    
	// weighting, manually input cheb0,1,2
	/*
     Double_t c_  = .1512125;
     Double_t c1_ = 1.942426080;
     Double_t c2_ = 1.7102450450;
     Double_t c3_ = 1.602523010;
     
    Double_t cheb0_ = 0.021121;
	Double_t cheb1_ = 0.251135;
	Double_t cheb2_ = 0.031226;
    */

	Double_t c4_ = 0.000510;
	...
	Double_t parLimitLow[nParmV]  = {    0,       0, mean_ -0.03,   0.01,   0,   0,    0,     0,          -15, -15, -15,  0, -15, -30, -30,-30};
	Double_t parLimitHigh[nParmV] = {N1_*1.3, Nbkg_*1.3, mean_ +0.03,    0.2,    5.1,   4.4,   5  ,   1,           15,  15,  15, 0.5,  15,  30,  30, 30};


  //  Double_t parLimitLow[nParmV]  = {    0,       0, mean_ -0.02,   0.01,   0,   0,    0,     0,          -15, -15, -15,  -1, -15, -30, -30,-30};
  //  Double_t parLimitHigh[nParmV] = {N1_*3, Nbkg_*4, mean_ +0.02,    0.2,    5.1,   4.4,   5  ,   1,           15,  15,  15, 0.5,  15,  30,  30, 30};
	...
	h_v2_SplusB->GetYaxis()->SetRangeUser(-0.05,0.07);
