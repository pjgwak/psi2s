...
void v2_bkg_systematic_doSim_pt65_50_y0_24_cent0_20(int cLow = 0, int cHigh = 20,
		...
		int ibkg_vn_sel = fpol2, bool fixSigPar=true)
{
	...
	TFile *wf = new TFile(Form("roots/v2_bkg_systematic_SimFitResult_Prompt_%s.root", kineLabel.Data()),"recreate");
    ...
    */
    ...
    Double_t parLimitLow[nParmV]  = {    0,       0, mean_-0.05,     0,   0.,   0.,    0,     0,  -1, -1, -1,  0., -10, -10, -10,-10};
    Double_t parLimitHigh[nParmV] = {N1_*1.1, Nbkg_*1.1, mean_+0.05,      0.1,    5.,   5.,  5.,  1.,   1,  1,  1, 0.5,  10,  10,  10, 10};
	...
	pad2->Draw();
	c_mass_v2->Update();
    c_mass_v2->SaveAs(Form("figs/v2_bkg_systematic_v2Mass_Prompt_%s.pdf", kineLabel.Data()));
	wf->cd();
