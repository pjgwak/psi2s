...
void signal_systematic_doSim_pt40_65_y16_24_cent20_120(int cLow = 20, int cHigh = 120,
		...
		int ibkg_vn_sel = fpol1, bool fixSigPar=true)
{
	...
	TFile *wf = new TFile(Form("roots/signal_systematic_SimFitResult_Prompt_%s.root", kineLabel.Data()),"recreate");
	...
	TFile* f_mass = new TFile(Form("../prompt_2D_fit/roots/mass/signal_systematic_MassFitResult_%s_PRw_Effw1_Accw1_PtW1_TnP1.root",kineLabel_.Data()),"read");
    ...
    Double_t c_  = 0.13654862024012;
    Double_t c1_ = 6.51035455403142;
    Double_t c2_ = 4.62656203010224;

    /*
     Double_t c_  = 0.13654862024011;
     Double_t c1_ = 6.51035455403142;
     Double_t c2_ = 4.62656203010224;
     
     // Best
     Double_t c_  = 0.02004001215170;
     Double_t c1_ = 9.01030311322410;
     Double_t c2_ = 7.000010122106;
     
     
     Double_t c_  = 0.0170;
     Double_t c1_ = 0.022410;
     Double_t c2_ = 0.022106;
     */
    ...
    Double_t parLimitLow[nParmV]  = {    0,       0, mean_ -0.02,     0,   0.,   0.,    0,     0,  -1, -1, -1,  0.005, -10, -10, -10,-10};
    Double_t parLimitHigh[nParmV] = {N1_*1.2, Nbkg_*1.2, mean_ +0.02,      0.4,    5.,   5.,  5.,  1.,   10,  10,  10, 0.3,  10,  10,  10, 10};
	...
	pad2->Draw();
	c_mass_v2->Update();
	c_mass_v2->SaveAs(Form("figs/signal_systematic_v2Mass_Prompt_%s.pdf", kineLabel.Data()));
	wf->cd();
