#ifndef tnp_weight_lowptPbPb_num_den_h
#define tnp_weight_lowptPbPb_num_den_h
#include "TMath.h"
...
double tnp_weight_trg_pbpb_num(double pt, double eta, int filterId=0,int idx=0);
double tnp_weight_trg_pbpb_den(double pt, double eta, int filterId=0,int idx=0);
...
double tnp_weight_trg_pbpb_num(double pt, double eta, int filterId,int idx) {
  double x = pt;
  double num=1, den=1, syst=0, statUp=0, statDown=0;
  if (filterId==0) { //L2 Jpsi
    if (idx != 99) {
  ...
  return num+syst_factor+stat_factor;
}

double tnp_weight_trg_pbpb_den(double pt, double eta, int filterId,int idx) {
  double x = pt;
  double num=1, den=1, syst=0, statUp=0, statDown=0;
  if (filterId==0) { //L2 Jpsi
    if (idx != 99) {
