void drawSysCent(){
  ...
  double systot[] = {0.030232433, 0.052839379};
  double sysacc[] = {0.002, 0.001};
  double syseff[] = {0.008, 0.019};
  double systnp[] = {0.015, 0.012};
  double syssgn[] = {0.006, 0.004};
  double sysbkg[] = {0.024, 0.007};
  double sysv2bkg[] = {0.003, 0.014};
  double sysbcont[] = {0, 0.045};

  double hsysbin[] = {0.0, 10.0, 60.0};

  TH1F *hSysTot = new TH1F("hSysTot",";Centrality (%) ;Variations",2, hsysbin);
  TH1F *hSysAcc = new TH1F("hSysAcc","; ;Systematics",2, hsysbin);
  TH1F *hSysEff = new TH1F("hSysEff","; ;Systematics",2, hsysbin);
  TH1F *hSysTnp = new TH1F("hSysTnp","; ;Systematics",2, hsysbin);
  TH1F *hSysSgn = new TH1F("hSysSgn","; ;Systematics",2, hsysbin);
  TH1F *hSysBkg = new TH1F("hSysBkg","; ;Systematics",2, hsysbin);
  TH1F *hSysv2Bkg = new TH1F("hSysv2Bkg","; ;Systematics",2, hsysbin);
  TH1F *hSysbCont = new TH1F("hSysbCont","; ;Systematics",2, hsysbin);
  for(int i = 0; i < 2; i++){
  ...
  c1->SaveAs("plot_psi2s_v2_sys_cent.png");
}
