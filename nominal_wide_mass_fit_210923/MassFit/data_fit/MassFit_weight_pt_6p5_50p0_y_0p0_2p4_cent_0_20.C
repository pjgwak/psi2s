		...
		)
{
	...
	TFile* f1 = new TFile("../../make_RooDataSet/roots/OniaRooDataSet_isMC0_pt_6.5_50.0_y_0.0_2.4_Cent_0_20_CtauCtu_0.0205_wPt1_wAccPt1_wTnPPR1_Psi_2S_210923.root","read");
    ...
    double sigma_1_init = 0.048;
    double x_init = 1.7774;
    double alpha_1_init = 1.8582;
    double n_1_init = 1.8503;
	double f_init = 0.58;
	double sl1_mean = 0.131, sl2_mean = 0.44, sl3_mean = 0.54;
	double N_Jpsi_high = 20000, N_Bkg_high = 551000;
