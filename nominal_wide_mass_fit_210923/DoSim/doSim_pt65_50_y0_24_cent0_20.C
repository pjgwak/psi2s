...
/*
 ...
 // 0.010 +- 0.021
 Double_t c_  = 0.060119;
 Double_t c1_ = 4.2113;
 Double_t c2_ = 1.3228;
 
 Double_t c_  = 0.0722;
 Double_t c1_ = 6.520114;
 Double_t c2_ = 4.120111;
 
 Double_t c_  = 0.1222;
 Double_t c1_ = 2.520114;
 Double_t c2_ = 4.120111;
  */
	Double_t c4_ = 0.0010;
    ...
    Double_t parLimitHigh[nParmV] = {N1_*1.2, Nbkg_*1.2, mean_+0.005,      0.1,    5.,   5.,  5.,  1.,   5,  5,  5, 0.3,  20,  20,  20, 20};
