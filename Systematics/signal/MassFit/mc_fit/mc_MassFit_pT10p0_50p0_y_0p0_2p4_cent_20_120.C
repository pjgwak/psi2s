...
void mc_MassFit_pT10p0_50p0_y_0p0_2p4_cent_20_120(
		...
		)
{
    ...
    /*
     ...
     double f_init = 0.35;
     double sl1_mean = 0.012, sl2_mean = 0.069, sl3_mean = 0.02;
     double N_Jpsi_high = 500000, N_Bkg_high = 3000;
	...
	//SIGNAL: initial params
	double sigma_1_init = 0.044;
	double x_init = 1.7017;
	double alpha_1_init = 1.9;
	double n_1_init = 1.6;
	double f_init = 0.65;
    double sl1_mean = 0.012, sl2_mean = 0.069, sl3_mean = 0.02;
    double N_Jpsi_high = 5000000, N_Bkg_high = 3000;
