...
void mc_MassFit_pT6p5_50p0_y_0p0_2p4_cent_0_120(
		...
		)
{
    ...
    double sigma_1_init = 0.036;
    double x_init = 1.35;
    double alpha_1_init = 1.842;
    double n_1_init = 1.83;
    double f_init = 0.40;
    double sl1_mean = 0.312, sl2_mean = 0.2, sl3_mean = 0.22;
    double N_Jpsi_high = 3500000, N_Bkg_high = 18000;
