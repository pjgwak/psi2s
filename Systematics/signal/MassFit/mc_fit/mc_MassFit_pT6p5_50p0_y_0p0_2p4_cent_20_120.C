...
void mc_MassFit_pT6p5_50p0_y_0p0_2p4_cent_20_120(
		...
		)
{
	...
	double sigma_1_init = 0.031;
	double x_init = 1.8;
	double alpha_1_init = 1.7;
	double n_1_init = 1.2;
	double f_init = 0.42;
    double sl1_mean = 0.112, sl2_mean = 0.3, sl3_mean = 0.12;
    double N_Jpsi_high = 1700000, N_Bkg_high = 18000;
