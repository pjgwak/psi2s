void simpleDrawPt_alpha(){
    gROOT->Macro("./rootlogon.C");

    // mid rapidity
    double xbin[] = {8.25, 30.0};
	double xerr[] = {1.75, 20.0};
	double ybin[] = {1.9292, 1.9506};
	double yerr[] = {0.0007, 0.0246};

    // mid rapidity, integrated (Cent. 10 ~ 60 %)
    double xbin2[] = {28.25};
    double xerr2[] = {21.75};
    double ybin2[] = {1.9435};
    double yerr2[] = {0.0007};
    ...
    TH1F *hPad = new TH1F("hPad",";p_{T} (GeV/c);#alpha", 10, 0.0, 50.0);
    hPad->SetMaximum(3.5);
    hPad->SetMinimum(1.5);
	...
	c1->SaveAs("plot_psi2s_mc_pt_alpha.pdf");
}
