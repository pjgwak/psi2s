void simpleDrawCent_n(){
    gROOT->Macro("./rootlogon.C");

	double xbin[] = {5, 35};
    double xerr[] = {5, 25};
	double ybin1[] = {1.2634, 0.8988};
	double yerr1[] = {0.0004, 0.0008};
	...
	TH1F *hPad = new TH1F("hPad",";Centrality (%);n", 10, 0.0, 100.0);
	...
	c1->SaveAs("plot_jpsi_mc_cent_n.pdf");
}
