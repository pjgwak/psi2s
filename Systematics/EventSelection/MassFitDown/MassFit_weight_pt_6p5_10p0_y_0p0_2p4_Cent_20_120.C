...
//		double sl1_mean = 0.10, double sl2_mean = 0.03, double sl3_mean = 0.02,
		...
		double sl1_mean = 0.10, double sl2_mean = 0.03, double sl3_mean = 0.02,
		double N_Jpsi_high = 24000, double N_Bkg_high = 380000,
...
//		double sl1_mean = 0.10, double sl2_mean = 0.03, double sl3_mean = 0.02,
		// 0.0598, 0.0176, -0.02270
		double sl1_mean = 0.10, double sl2_mean = 0.03, double sl3_mean = 0.02,
		double N_Jpsi_high = 45000, double N_Bkg_high = 480000,
		int PR=0, //0=PR, 1=NP, 2=Inc.
		int PRw=1, bool fEffW = true, bool fAccW = true, bool isPtW = true, bool isTnP = true
		)
{
    TString DATE = "210913";//210827
	...
	//###TFile* f1 = new TFile("../OniaRooDataSet_isMC0_pt_6.5_10.0_y_0.0_2.4_Cent_20_120_CtauCtu_0.0285_wPt1_wAccPt1_wTnPPR0_Psi_2S_20210831.root");
	TFile* f1 = new TFile("../roots/OniaRooDataSet_isMC0_pt_6.5_10.0_y_0.0_2.4_Cent_20_120_CtauCtu_0.0285_wPt1_wAccPt1_wTnPPR1_Psi_2S_Down_20210901.root");
  ...
  RooRealVar *sl2 = new RooRealVar("sl2","sl2", sl2_mean, -10., 10.);
	...
	//Build the model
	RooRealVar *N_Jpsi= new RooRealVar("N_Jpsi","inclusive Jpsi signals",N_Jpsi_high*0.6, 0, N_Jpsi_high*1.4);
	RooRealVar *N_Bkg = new RooRealVar("N_Bkg","fraction of component 1 in bkg",N_Bkg_high*0.6, 0, N_Bkg_high*1.4);
