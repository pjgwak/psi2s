...
//		double sl1_mean = 0.10, double sl2_mean = 0.03, double sl3_mean = 0.02,
		...
		double sl1_mean = 0.10, double sl2_mean = 0.03, double sl3_mean = 0.02,
		double N_Jpsi_high = 17000, double N_Bkg_high = 470000,
		int PR=0, //0=PR, 1=NP, 2=Inc.
		int PRw=1, bool fEffW = true, bool fAccW = true, bool isPtW = false, bool isPtWAcc = true, bool isTnP = true
		)
{
    TString DATE = "210901";
	...
	TFile* f1 = new TFile("../OniaRooDataSet_isMC0_pt_6.5_10.0_y_0.0_2.4_Cent_20_120_CtauCtu_0.0285_wPt0_wAccPt1_wTnPPR1_Psi_2S_20210831.root","READ");
	//TFile* f1 = new TFile("../OniaRooDataSet_isMC0_pt_6.5_10.0_y_0.0_2.4_Cent_20_120_CtauCtu_0.0285_wPt0_wAccPt1_wTnPPR1_Psi_2S_20210831.root","READ");
	...
	//Cent.10-20
    double paramsupper[8] = {0.09,      5.,         5,      5,      1.0,     25.0};
    double paramslower[8] = {0.0001,   0.0001,     0.0001, 0.0001,  0.01,      0.0};
    
	//SIGNAL: initial params
	double sigma_1_init = 0.0414;
...
//###
	myPlot2_A->SetMinimum(10500);
	myPlot2_A->SetMaximum(22500);
