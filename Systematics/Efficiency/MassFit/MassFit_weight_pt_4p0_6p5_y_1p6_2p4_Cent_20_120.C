...
void MassFit_weight_pt_4p0_6p5_y_1p6_2p4_Cent_20_120(
		...
		double N_Jpsi_high = 16800, double N_Bkg_high = 1600000,
		...
		)
{
	...
	TFile* f1 = new TFile("../OniaRooDataSet_isMC0_pt_4.0_6.5_y_1.6_2.4_Cent_20_120_CtauCtu_0.0395_wPt0_wAccPt1_wTnPPR1_Psi_2S_20210831.root","READ");
    ...
    double paramslower[8] = {0,       0,      0, 0, 0,      -10.};
	...
	//RooRealVar   *x_A = new RooRealVar("x_A","sigma ratio ", x_init, x_init-1.0, x_init+1.0);
	...
	//RooRealVar    alpha_1_A("alpha_1_A","tail shift", alpha_1_init, alpha_1_init-1.0, alpha_1_init+1.0);
