...
//		2738, 19520 // 65000, 700000
		double N_Jpsi_high = 15000, double N_Bkg_high = 380000,
		...
		)
{
	...
	TFile* f1 = new TFile("../OniaRooDataSet_isMC0_pt_6.5_50.0_y_0.0_2.4_Cent_20_120_CtauCtu_0.0195_wPt0_wAccPt1_wTnPPR1_Psi_2S_20210831.root","READ");
	...
	//Cent.10-20
    double paramsupper[8] = {0.9,      5.,         5,      5,       1.0,     25.0};
...
*/
	...
	//Build the model
	RooRealVar *N_Jpsi= new RooRealVar("N_Jpsi","inclusive Jpsi signals",N_Jpsi_high*0.5, 0, N_Jpsi_high*1.5);
	...
	RooRealVar *N_Bkg = new RooRealVar("N_Bkg","fraction of component 1 in bkg",N_Bkg_high*0.5, 0, N_Bkg_high*1.5);
