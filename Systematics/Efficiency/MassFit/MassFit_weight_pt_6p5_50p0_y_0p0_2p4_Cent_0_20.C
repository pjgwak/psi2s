...
void MassFit_weight_pt_6p5_50p0_y_0p0_2p4_Cent_0_20(
		...
		double sl1_mean = 0.2030, double sl2_mean = -.004, double sl3_mean = 0.40062,
		double N_Jpsi_high = 10000, double N_Bkg_high = 350000,
		...
		)
{
	...
	TFile* f1 = new TFile("../OniaRooDataSet_isMC0_pt_6.5_50.0_y_0.0_2.4_Cent_0_20_CtauCtu_0.0205_wPt0_wAccPt1_wTnPPR1_Psi_2S_20210831.root","READ");
    ...
    double paramsupper[8] = {0.8,     5.,     5,  5,  1,       25.0};
    double paramslower[8] = {0.,      0.,     0., 0., 0.001,      0};
    
	//SIGNAL: initial params
    double sigma_1_init = 0.06;
	double x_init = 0.5574;
	double alpha_1_init = 1.8489;
	double n_1_init = 1.8988;
	double f_init = 0.45;
    ...
    RooRealVar   *x_A = new RooRealVar("x_A","sigma ratio ", x_init, x_init-0.0, x_init+0.0);
    ...
    RooRealVar    alpha_1_A("alpha_1_A","tail shift", alpha_1_init, alpha_1_init-0.0, alpha_1_init+0.0);
    RooFormulaVar alpha_2_A("alpha_2_A","1.0*@0",RooArgList(alpha_1_A) );
    RooRealVar    n_1_A("n_1_A","power order", n_1_init, n_1_init-0.0, n_1_init+0.0);
