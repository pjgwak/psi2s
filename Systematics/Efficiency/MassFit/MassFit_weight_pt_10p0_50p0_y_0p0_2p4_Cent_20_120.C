...
//###		double N_Jpsi_high = 5000, double N_Bkg_high = 30000,
		...
		int PRw=1, bool fEffW = true, bool fAccW = true, bool isPtW = false, bool isPtWAcc = true, bool isTnP = true // added
		)
{
    TString DATE = "210901";
	...
	TFile* f1 = new TFile("../OniaRooDataSet_isMC0_pt_10.0_50.0_y_0.0_2.4_Cent_20_120_CtauCtu_0.0185_wPt0_wAccPt1_wTnPPR1_Psi_2S_20210831.root","READ");
