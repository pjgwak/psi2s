...
void test(int cLow = 20, int cHigh = 120,
		...
		int ibkg_vn_sel = fpol1, bool fixSigPar=true)
{
    ...
    TFile* rf = new TFile(Form("../Psi2S_Prompt_%s_Eff1_Acc1_PtW0_PtWAcc1_TnP1.root",kineLabel.Data()),"read");
    ...
    TFile* f_mass = new TFile(Form("../MassFit/roots/mass/210901/MassFitResult_%s_PRw_Effw1_Accw1_PtW0_PtWAcc1_TnP1.root",kineLabel_.Data()),"read");
