		...
		)
{
    ...
    /*
     double sigma_1_init = 0.0714;
     double x_init = 1.7774;
     double alpha_1_init = 1.8582;
     double n_1_init = 1.8503;
     double f_init = 0.04;
     double m_lambda_init = 6;
     double sl1_mean = 0.2, sl2_mean = 0.31, sl3_mean = 0.31;
     double N_Jpsi_high = 17000, N_Bkg_high = 433000;
     */
    ...
    double sl1_mean = 0.28, sl2_mean = 0.06, sl3_mean = 0.01;
    double N_Jpsi_high = 18000, N_Bkg_high = 428000;
	...
	//Build the model
	RooRealVar *N_Jpsi= new RooRealVar("N_Jpsi","inclusive Jpsi signals",N_Jpsi_high*0.7,0, N_Jpsi_high);
