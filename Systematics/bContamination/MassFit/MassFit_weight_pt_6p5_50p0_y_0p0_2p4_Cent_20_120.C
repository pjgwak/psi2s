...
//		2738, 19520 // 65000, 700000
		double N_Jpsi_high = 20000, double N_Bkg_high = 500000,
		...
		)
{
	...
	TFile* f1 = new TFile("../OniaRooDataSet_isMC0_pt_6.5_50.0_y_0.0_2.4_Cent_20_120_CtauCtu_0.0435_wPt1_wAccPt1_wTnPPR1_Psi_2S_20210831.root");
