...
void MassFit_weight_pt_6p5_50p0_y_0p0_2p4_Cent_0_20(
		...
		double sl1_mean = 0.5030, double sl2_mean = -.004, double sl3_mean = 0.40062,
		//double sl1_mean = 0.2030, double sl2_mean = -.004, double sl3_mean = 0.40062,
		double N_Jpsi_high = 20000, double N_Bkg_high = 450000,
		...
		)
{
	...
	TFile* f1 = new TFile("../OniaRooDataSet_isMC0_pt_6.5_50.0_y_0.0_2.4_Cent_0_20_CtauCtu_0.0455_wPt1_wAccPt1_wTnPPR1_Psi_2S_20210831.root");
