...
void MassFit_weight_pt_10p0_50p0_y_0p0_2p4_Cent_20_120(
		float ptLow=10.0, float ptHigh=50.0,
		float yLow=0.0, float yHigh=2.4,
		int cLow=20, int cHigh=120,
//		double sl1_mean = 0.10, double sl2_mean = 0.03, double sl3_mean = 0.02,
		// 0.0598, 0.0176, -0.02270
		double sl1_mean = 0.512, double sl2_mean = 0.369, double sl3_mean = 0.32,
//		2738, 19520 // 40000, 50000 - 2515, 19744 // 5000, 30000
//###		double N_Jpsi_high = 5000, double N_Bkg_high = 30000,
		double N_Jpsi_high = 5000, double N_Bkg_high = 30000,
		...
		)
{
	...
	TFile* f1 = new TFile("../OniaRooDataSet_isMC0_pt_10.0_50.0_y_0.0_2.4_Cent_20_120_CtauCtu_0.0185_wPt1_wAccPt0_wTnPPR1_Psi_2S_20210831.root","READ");
	...
	//Cent.10-20
    double paramsupper[8] = {0.4,      5.,         5,      5,      1.0,     25.0};
    double paramslower[8] = {0.0001,   0.0001,     0.0001, 0.0001, 0.0,      0.0};
    
	//SIGNAL: initial params
	double sigma_1_init = 0.04;
    double x_init = 0.5255;
    double alpha_1_init = 1.9889;
    double n_1_init = 1.4389;
	double f_init = 0.4;
    ...
    //Build the model
    RooRealVar *N_Jpsi= new RooRealVar("N_Jpsi","inclusive Jpsi signals",N_Jpsi_high*0.6, 0, N_Jpsi_high*1.3);
