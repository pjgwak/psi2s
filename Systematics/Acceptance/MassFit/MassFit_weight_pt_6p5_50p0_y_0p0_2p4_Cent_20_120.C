...
void MassFit_weight_pt_6p5_50p0_y_0p0_2p4_Cent_20_120(
		float ptLow=6.5, float ptHigh=50.0,
		float yLow=0.0, float yHigh=2.4,
		int cLow=20, int cHigh=120,
        double sl1_mean = 0.03, double sl2_mean = -0.03, double sl3_mean = -0.02,
		// 0.512, 0.369, 0.32
//		2738, 19520 // 65000, 700000
		double N_Jpsi_high = 15000, double N_Bkg_high = 350000,
		...
		)
{
	...
	TFile* f1 = new TFile("../OniaRooDataSet_isMC0_pt_6.5_50.0_y_0.0_2.4_Cent_20_120_CtauCtu_0.0195_wPt1_wAccPt0_wTnPPR1_Psi_2S_20210831.root","READ");
	...
	//Cent.10-20
    double paramsupper[8] = {0.5,      5.,         5,      5,       1.0,     25.0};
    double paramslower[8] = {0.0001,   0.0001,     0.0001, 0.0001,  0.02,      0.0};
