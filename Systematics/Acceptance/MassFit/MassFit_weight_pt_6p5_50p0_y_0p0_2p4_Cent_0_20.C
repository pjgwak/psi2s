...
void MassFit_weight_pt_6p5_50p0_y_0p0_2p4_Cent_0_20(
		...
		double N_Jpsi_high = 10000, double N_Bkg_high = 340000,
		...
		)
{
	...
	TFile* f1 = new TFile("../OniaRooDataSet_isMC0_pt_6.5_50.0_y_0.0_2.4_Cent_0_20_CtauCtu_0.0205_wPt1_wAccPt0_wTnPPR1_Psi_2S_20210831.root","READ");
    ...
    double paramsupper[8] = {0.8,    5.,     5,  5,  0.9,      25.0};
    double paramslower[8] = {0.,     0.,     0., 0., 0.02,      0};
  ...
  */
	...
	//Build the model
	RooRealVar *N_Jpsi= new RooRealVar("N_Jpsi","inclusive Jpsi signals",N_Jpsi_high*0.8, 0, N_Jpsi_high*1.3);
	RooRealVar *N_Bkg = new RooRealVar("N_Bkg","fraction of component 1 in bkg",N_Bkg_high*0.8, 0, N_Bkg_high*1.2);
