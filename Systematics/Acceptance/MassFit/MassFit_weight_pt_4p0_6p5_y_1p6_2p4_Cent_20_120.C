...
void MassFit_weight_pt_4p0_6p5_y_1p6_2p4_Cent_20_120(
		...
		double sl1_mean = 0.072, double sl2_mean = -.0569, double sl3_mean = 0.032,
		//double sl1_mean = 0.042, double sl2_mean = -.0569, double sl3_mean = 0.032,
		double N_Jpsi_high = 14800, double N_Bkg_high = 1413396,
		...
		)
{
	...
	//Cent.10-20
    double paramsupper[8] = {0.08,    5.,     5, 5,  1.0,     25.0};
    double paramslower[8] = {0,       0,      0, 0,  0.01,      -10.};
    
	//SIGNAL: initial params
	double sigma_1_init = 0.06;
	double x_init = 1.6793;
	double alpha_1_init = 2.2608;
	double n_1_init = 1.0117;
	double f_init = 0.3268;//0.6533;
	double m_lambda_init = 4.82;
	...
	//Build the model
	RooRealVar *N_Jpsi= new RooRealVar("N_Jpsi","inclusive Jpsi signals",N_Jpsi_high*0.6, 0, N_Jpsi_high*1.5);
	RooRealVar *N_Bkg = new RooRealVar("N_Bkg","fraction of component 1 in bkg",N_Bkg_high*0.6, 0, N_Bkg_high*1.3);
