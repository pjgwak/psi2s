		...
		int ibkg_vn_sel = fpol1, bool fixSigPar=true)
{
    ...
    Double_t c_  = 0.17111568;
    Double_t c1_ = 7.04555368;
    Double_t c2_ = 3.05156459;
    ...
    Double_t parLimitHigh[nParmV] = {N1_*1.2, Nbkg_*1.2, mean_+0.005,      0.1,    5.,   5.,  5.,  1.,   10,  10,  10, 0.2,  20,  20,  20, 20};
