...
void mc_MassFit_pT4p0_6p5_y_1p6_2p4_cent_20_120(
		...
		)
{
    ...
    double alpha_1_init = 1.77;
    double x_init = 1.2;
    double n_1_init = 1.1;
    double f_init = 0.87;
    double sl1_mean = .158, sl2_mean = 0.1558, sl3_mean = 0.158;
    double N_Jpsi_high = 2500000, N_Bkg_high = 10000;
	...
	if (logY_flag == true) {
		...
		myPlot2_A->GetYaxis()->SetRangeUser(0,20000);
	}
