		...
		)
{
    ...
    double x_init = 1.1456;
    double alpha_1_init = 1.8412;
    double n_1_init = 1.9332;
	double f_init = 0.491;
	double m_lambda_init = 6;
	double sl1_mean = 0.48, sl2_mean = 0.33, sl3_mean = 0.12;
	double N_Jpsi_high = 13000, N_Bkg_high = 380000;
