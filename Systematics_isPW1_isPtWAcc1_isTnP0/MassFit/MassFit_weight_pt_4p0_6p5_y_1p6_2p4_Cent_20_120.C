...
void MassFit_weight_pt_4p0_6p5_y_1p6_2p4_Cent_20_120(
		...
		double sl1_mean = 0.42, double sl2_mean = 0.534, double sl3_mean = 0.62,
		double N_Jpsi_high = 23000, double N_Bkg_high = 1450000,
		...
		)
{
	...
	//Cent.10-20
    double paramsupper[8] = {0.06,    5.,     5, 5, 0.90,     10.0};
    double paramslower[8] = {0.001,   0,     0, 0, 0.1,      -5};
	...
	//SIGNAL
	RooRealVar    mean("m_{J/#Psi}","mean of the signal gaussian mass PDF",psi_2S_mass, psi_2S_mass -0.2, psi_2S_mass + 0.2 ) ;
	...
	//Build the model
    RooRealVar *N_Jpsi= new RooRealVar("N_Jpsi","inclusive Jpsi signals",N_Jpsi_high*0.9, 10000, N_Jpsi_high);
