...
void bkg_systematic_MassFit_weight_pt_4p0_6p5_y_1p6_2p4_Cent_20_120(
		...
		double sl1_mean = .2146, double sl2_mean = -0.10602, double sl3_mean = 0.603,
		double N_Jpsi_high = 28000, double N_Bkg_high = 2660000,
		...
		)
{
    ...
    double paramsupper[8] = {0.055,    5.,     5, 5, 0.9,     10.};
    double paramslower[8] = {0,   0,     0, 0, 0.1,      -5.};
    
    //SIGNAL: initial params
    double sigma_1_init = 0.02;
    ...
    //SIGNAL
    RooRealVar    mean("m_{J/#Psi}","mean of the signal gaussian mass PDF",psi_2S_mass, psi_2S_mass-0.015, psi_2S_mass+0.015 ) ;
    ...
    //Build the model
    RooRealVar *N_Jpsi= new RooRealVar("N_Jpsi","inclusive Jpsi signals",N_Jpsi_high*0.8,800, N_Jpsi_high);
