...
void signal_systematic_MassFit_weight_pt_4p0_6p5_y_1p6_2p4_Cent_20_120(
		...
		double sl1_mean = .2006112, double sl2_mean = 0.23369, double sl3_mean = 0.700432,
		double N_Jpsi_high =18000, double N_Bkg_high = 2440000,
		...
		)
{
    ...
    //Build the model
    RooRealVar *N_Jpsi= new RooRealVar("N_Jpsi","inclusive Jpsi signals",1000, N_Jpsi_high);
