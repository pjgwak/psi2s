...
void signal_systematic_MassFit_weight_pt_6p5_50p0_y_0p0_2p4_Cent_0_20(
		...
		double sl1_mean = 0.26, double sl2_mean = 0.13, double sl3_mean = 0.14,
		double N_Jpsi_high = 12000, double N_Bkg_high = 330000,
		...
		)
{
    ...
    //Cent.10-20
    double paramsupper[8] = {0.06,    5.,     5, 5,     0.95,     15};
    double paramslower[8] = {0.,   0.,     0., 0., 0.01,      -5};
    
    //SIGNAL: initial params
    double sigma_1_init = 0.0003;
