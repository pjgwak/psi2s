...
void signal_systematic_MassFit_weight_pt_10p0_50p0_y_0p0_2p4_Cent_20_120(
		float ptLow=10.0, float ptHigh=50.0,
		float yLow=0.0, float yHigh=2.4,
		int cLow=20, int cHigh=120,
		double sl1_mean = 0.54, double sl2_mean = 0.39, double sl3_mean = 0.2,
		double N_Jpsi_high = 5000, double N_Bkg_high = 55000,
		...
		)
{
    ...
    //Cent.10-20
    double paramsupper[8] = {0.4,    1.0,     5, 5, 1.0,     25.0};
    double paramslower[8] = {0.01,   0.0,     -5, -5, 0.0,     -10.0};
