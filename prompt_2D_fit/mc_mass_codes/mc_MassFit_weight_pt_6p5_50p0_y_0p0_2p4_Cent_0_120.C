...
void mc_MassFit_weight_pt_6p5_50p0_y_0p0_2p4_Cent_0_120(
		float ptLow=6.5, float ptHigh=50.0,
		float yLow=0.0, float yHigh=2.4,
		int cLow=0, int cHigh=120,
		double sl1_mean = 0.312, double sl2_mean = 0.2, double sl3_mean = 0.22,
		double N_Jpsi_high = 3500000, double N_Bkg_high = 18000,
		...
		)
{
	...
	//Cent.10-20
	double paramsupper[8] = {0.4,    3.0,     5, 5, 1.0,     25.0};
