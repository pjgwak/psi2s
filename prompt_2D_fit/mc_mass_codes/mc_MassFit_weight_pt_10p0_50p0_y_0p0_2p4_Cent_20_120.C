...
void mc_MassFit_weight_pt_10p0_50p0_y_0p0_2p4_Cent_20_120(
...
//		double sl1_mean = 0.10, double sl2_mean = 0.03, double sl3_mean = 0.02,
		...
		double sl1_mean = 0.012, double sl2_mean = 0.069, double sl3_mean = 0.02,
//		2738, 19520 // 40000, 50000 - 2515, 19744 // 5000, 30000
//###		double N_Jpsi_high = 5000, double N_Bkg_high = 30000,
		double N_Jpsi_high = 500000, double N_Bkg_high = 3000,
		...
		)
{
	...
	//Cent.10-20
    double paramsupper[8] = {0.4,    5.,     5., 8., 1.0,     25.0};
    double paramslower[8] = {0.001,   0.0,     0.1, 0.1, 0.,      0.0};
    
	//SIGNAL: initial params
	double sigma_1_init = 0.04;
	double x_init = 0.5;
	double alpha_1_init = 2.1;
	double n_1_init = 1.34;
	double f_init = 0.35;
    ...
    */
    ...
    if (logY_flag == true) {
        ...
        myPlot2_A->GetYaxis()->SetRangeUser(0,50000);
    }
