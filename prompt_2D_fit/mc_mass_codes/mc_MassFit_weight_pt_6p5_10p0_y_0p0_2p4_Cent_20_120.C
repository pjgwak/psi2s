...
void mc_MassFit_weight_pt_6p5_10p0_y_0p0_2p4_Cent_20_120(
		float ptLow=6.5, float ptHigh=10.0,
		float yLow=0.0, float yHigh=2.4,
		int cLow=20, int cHigh=120,
		double sl1_mean = 0.05, double sl2_mean = 0.04, double sl3_mean = 0.06,
		double N_Jpsi_high = 2000000, double N_Bkg_high = 200000,
