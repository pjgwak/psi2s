...
void mc_MassFit_weight_pt_4p0_6p5_y_1p6_2p4_Cent_20_120(
		...
		double N_Jpsi_high = 2500000, double N_Bkg_high = 10000,
		...
		)
{
    ...
    double paramsupper[8] = {0.4,    3,    3., 5., 1.,     25.0};
    double paramslower[8] = {0.001,   0.001,   0.001, 0.001, 0.15,      0.0};
    
	//SIGNAL: initial params
	double sigma_1_init = 0.055;
	double x_init = 1.67;
	double alpha_1_init = 2.4385;
	double n_1_init = 1.1;
	double f_init = 0.28;
