...
void MassFit_weight_pt_4p0_6p5_y_1p6_2p4_Cent_20_120(
		...
		double sl1_mean = 0.622, double sl2_mean = 0.36, double sl3_mean = 0.42,
		double N_Jpsi_high = 18000, double N_Bkg_high = 1440000,
