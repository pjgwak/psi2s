...
void signal_systematic_MassFit_weight_pt_4p0_6p5_y_1p6_2p4_Cent_20_120(
		float ptLow=4.0, float ptHigh=6.5,
		float yLow=1.6, float yHigh=2.4,
		int cLow=20, int cHigh=120,
		double sl1_mean =0.34112, double sl2_mean = 0.3239, double sl3_mean = 0.47032,
		double N_Jpsi_high =23000, double N_Bkg_high = 2540000,
		int PR=0, //0=PR, 1=NP, 2=Inc.
		int PRw=1, bool fEffW = true, bool fAccW = true, bool isPtW = true, bool isTnP = true
		)
{
    TString DATE = "210901_sig";
    ...
    TFile* f1 = new TFile("../make_RooDataSet/roots/OniaRooDataSet_isMC0_pt_4.0_6.5_y_1.6_2.4_Cent_20_120_CtauCtu_0.0395_wPt1_wAccPt1_wTnPPR1_Psi_2S_20210831.root","read");
    ...
    //Cent.10-20
    double paramsupper[8] = {0.06,    5,     5, 5, 0.90,     15.0};
    double paramslower[8] = {0.01   ,   0.0,     0, 0, 0.1,      -5.0};
    
    //SIGNAL: initial params
    double sigma_1_init = 0.034;
    ...
    //Build the model
    RooRealVar *N_Jpsi= new RooRealVar("N_Jpsi","inclusive Jpsi signals",N_Jpsi_high*0.5, N_Jpsi_high*1.3);
    RooRealVar *N_Bkg = new RooRealVar("N_Bkg","fraction of component 1 in bkg", N_Bkg_high*0.5, N_Bkg_high*1.3);
    ...
    */
    ...
    TFile* outFile;
    //if (PR==2) {
        outFile = new TFile(Form("roots/mass/%s/signal_systematic_MassFitResult_%s_%sw_Effw%d_Accw%d_PtW%d_TnP%d.root", DATE.Data(), kineLabel.Data(), fname.Data(), fEffW, fAccW, isPtW, isTnP),"recreate");
        c_A->SaveAs(Form("figs/mass/%s/signal_systematic_Mass_%s_%sw_Effw%d_Accw%d_PtW%d_TnP%d.pdf", DATE.Data(), kineLabel.Data(), fname.Data(), fEffW, fAccW, isPtW, isTnP));
    //}
