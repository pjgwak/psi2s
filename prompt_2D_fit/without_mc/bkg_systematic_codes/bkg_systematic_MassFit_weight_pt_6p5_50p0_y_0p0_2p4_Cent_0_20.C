...
void bkg_systematic_MassFit_weight_pt_6p5_50p0_y_0p0_2p4_Cent_0_20(
		...
		// double sl1_mean = 0.91, double sl2_mean = 0.8, double sl3_mean = 0.4,
		// double N_Jpsi_high = 8600, double N_Bkg_high = 700000,
		double sl1_mean = 0.90, double sl2_mean = 0.8, double sl3_mean = 0.4,
		double N_Jpsi_high = 8600, double N_Bkg_high = 700000,
