...
void signal_systematic_MassFit_weight_pt_4p5_6p5_y_1p6_2p4_Cent_20_120(
		float ptLow=4.5, float ptHigh=6.5,
		float yLow=1.6, float yHigh=2.4,
		int cLow=20, int cHigh=120,
		double sl1_mean = 0.312, double sl2_mean = 0.369, double sl3_mean = 0.32,
		double N_Jpsi_high =18000, double N_Bkg_high = 1000000,
