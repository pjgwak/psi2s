...
void bkg_systematic_MassFit_weight_pt_6p5_50p0_y_0p0_2p4_Cent_20_120(
		float ptLow=6.5, float ptHigh=50.0,
		float yLow=0.0, float yHigh=2.4,
		int cLow=20, int cHigh=120,
		double sl1_mean = 0.042, double sl2_mean = 0.03, double sl3_mean = 0.19,
		double N_Jpsi_high = 17000, double N_Bkg_high = 380000,
