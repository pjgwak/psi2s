...
void bkg_systematic_MassFit_weight_pt_6p5_50p0_y_0p0_2p4_Cent_0_20(
		float ptLow=6.5, float ptHigh=50.0,
		float yLow=0.0, float yHigh=2.4,
		int cLow=0, int cHigh=20,
		double sl1_mean = 0.30, double sl2_mean = 0.8, double sl3_mean = 0.21,
		double N_Jpsi_high = 7000, double N_Bkg_high = 545000,
		...
		)
{
    ...
    //Cent.10-20
    double paramsupper[8] = {0.048,    5.,     5, 5, 0.95,     15.0};
    double paramslower[8] = {0.0001,   0.,     0., 0., 0.001,      -5};
    
    //SIGNAL: initial params
    double sigma_1_init = 0.042;
