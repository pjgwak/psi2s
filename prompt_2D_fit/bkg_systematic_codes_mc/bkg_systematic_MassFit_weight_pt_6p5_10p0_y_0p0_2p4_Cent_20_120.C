...
void bkg_systematic_MassFit_weight_pt_6p5_10p0_y_0p0_2p4_Cent_20_120(
		float ptLow=6.5, float ptHigh=10.0,
		float yLow=0.0, float yHigh=2.4,
		int cLow=20, int cHigh=120,
		double sl1_mean = 0.0542, double sl2_mean = 0.054, double sl3_mean = 0.012,
		...
		)
{
    ...
    TFile* f1 = new TFile("../make_RooDataSet/roots/OniaRooDataSet_isMC0_pt_6.5_10.0_y_0.0_2.4_Cent_20_120_CtauCtu_0.0285_wPt1_wAccPt1_wTnPPR1_Psi_2S_20210831.root","read");
